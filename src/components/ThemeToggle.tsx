  ...
  return (
    ...
    >
      {isDark ? (
        ...
        <svg
          className="w-6 h-6 text-yellow-500 transition-transform duration-300 hover:rotate-45"
          fill="none"
          stroke="currentColor"
          viewBox="0 0 24 24"
        >
        ...
        <svg
          className="w-6 h-6 text-purple-accent transition-transform duration-300 hover:-rotate-12"
          fill="none"
          stroke="currentColor"
          viewBox="0 0 24 24"
        >
